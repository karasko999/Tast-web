// auth-system.js - نظام المصادقة الكامل (مع حفظ البيانات)
...
class AuthSystem {
    ...
    async loadUserData(uid) {
        try {
            ...
            if (doc.exists) {
                ...
                console.log("✅ بيانات المستخدم المحملة:", this.currentUser);
            } else {
            ...
            // إنشاء كائن مؤقت في حالة فشل التحميل
    ...
    async createUserProfile(uid) {
        try {
            ...
            console.log("✅ تم إنشاء ملف تعريف جديد:", userData);
        } catch (error) {
...
console.log("✅ AuthSystem (محسّن) initialized");