// admin.js - إدارة الخطط مع التصنيفات الجديدة
...
// ─── تحديث قائمة التصنيفات الفرعية حسب التصنيف الرئيسي ───
...
console.log('✅ admin.js (مع تصنيفات) جاهز');